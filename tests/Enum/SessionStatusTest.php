...
final class SessionStatusTest extends AbstractEnumTestCase
{
    ...
    {
        $this->assertEquals(BadgeInterface::SECONDARY, SessionStatus::PENDING->getBadge());
        $this->assertEquals(BadgeInterface::PRIMARY, SessionStatus::IN_PROGRESS->getBadge());
        $this->assertEquals(BadgeInterface::SUCCESS, SessionStatus::COMPLETED->getBadge());
        $this->assertEquals(BadgeInterface::WARNING, SessionStatus::EXPIRED->getBadge());
        $this->assertEquals(BadgeInterface::DANGER, SessionStatus::CANCELLED->getBadge());
    }
